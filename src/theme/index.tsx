...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    text6: darkMode ? 'white' : 'white',
    text7: darkMode ? '#000' : '#000',

    // backgrounds / greys
    bg1: darkMode ? '#1d1f24' : '#1d1f24',
    bg2: darkMode ? 'transparent' : 'transparent',
    bg3: darkMode ? '#cd77d3' : '#cd77d3',
...
body {
  ...
  // background: radial-gradient(circle at center, #800080 10%, #FFC0CB 60%, #FFFFFF 100%);
