...
const getTokenLogoURL = (address: string, chainId?: ChainId) => chainId === ChainId.MAINNET ?
...
export default function CurrencyLogo({
  ...
  const srcs: string[] = useMemo(() => {
    ...
    return [];
  }, [ETHER, currency, uriLocations]);

  if (currency === ETHER || currency?.symbol === "WBNB") {
    return chainId === ChainId.MAINNET ? <StyledEthereumLogo src={EthereumLogo} size={size} style={style} /> : 
    <StyledEthereumLogo src={BnbLogo} size={size} style={style} />;
  }
